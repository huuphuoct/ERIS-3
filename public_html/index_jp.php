...
<head>
	...
	<link rel="stylesheet" href="css/styles_japan.css">
...
if(isset($_POST['login'])){
	...
	if($user & $pass)
	{
		...
		if(mysql_num_rows($sql)==0){
			...
			header("location:main_japan.php");
		}
	}
			...
			<div class="container">
				<div class="row row-main">
                    ...
                    <form name="frmlogin" action="" method="post" onSubmit="return Check()">
						<h1 class="main-title">よこそう</h1>
						<p>よこそう、こらは私のウェブサイトです。ユーザー名とパスコードを入力してください。</p>
<div class="graph_action">
		  <a href="in.php" class="forgot-password">&#12496;&#12483;&#12463;</a>
        </div>
					</div>
					<div class="col-md-4 col">
						...
						<form class="main-form">
							<div class="form-group">
								<input type="text" name="user" class="form-control" placeholder="ユーザー名またはメールアドレス">
							...
							<input type="submit" name="login" value="ログイン" class="btn btn-default btn-ghost">
						</form>
						<a href="email_japan.php" class="forgot-password">パスワードをお忘れですか?</a>
					</div>
					<div class="col-md-4 col">
						<h1 class="main-title">初めて?</h1>
						<form class="main-form">
							<div class="form-group">
								<input type="text" class="form-control" placeholder="名前と苗字">
								<div class="form-icon lin lin-user"></div>
							</div>
							<div class="form-group">
							...
							<input type="submit" value="登録" class="btn btn-default btn-ghost">
						</form>
					</div>
				</div>
			</div>
