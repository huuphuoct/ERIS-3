...
<head>
	...
	<link rel="stylesheet" href="css/styles_usa.css">
</head>
</script>
			...
			<div class="container">
				<div class="row row-main">
                    ...
                    <form name="frmlogin" action="" method="post" onSubmit="return Check()">
						...
						<p>Thanks for using my website, please enter username and password to discover more</p>
<div class="graph_action">
		  <a href="in.php" class="forgot-password">Back</a>
        </div>
					</div>
					<div class="col-md-4 col">
						...
						<form class="main-form">
							...
							<input type="submit" name="login" value="Login" class="btn btn-default btn-ghost">
						</form>
						<a href="email_usa.php" class="forgot-password">Forgot the password?</a>
					</div>
					<div class="col-md-4 col">
						<h1 class="main-title">First time?</h1>
						<form class="main-form">
							<div class="form-group">
							...
							<input type="submit" value="Register" class="btn btn-default btn-ghost">
						</form>
					</div>
				</div>
			</div>
