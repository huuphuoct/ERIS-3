...
<head>
	...
	<link rel="stylesheet" href="css/styles_vietnam.css">
</head>
</script>
...
if(isset($_POST['login'])){
	...
	if($user & $pass)
	{
		...
		if(mysql_num_rows($sql)==0){
			...
			header("location:main_vietnam.php");
		}
	}
			...
			<div class="container">
				<div class="row row-main">
					<div class="col-md-4 col">
						...
						<p>Cảm ơn bạn vi` sử dụng website của mình, xin bạn hãy điền tên và mật khẩu</p>
<form name="frmlogin" action="" method="post" onSubmit="return Check()">

<div class="graph_action">
		 <a href='in.php' class="forgot-password">Tr&#7903; v&#7873;</a>
        </div>
					</div>
					<div class="col-md-4 col">
						...
						<form class="main-form">
							...
							<input type="submit" name="login" value="Nhập" class="btn btn-default btn-ghost">
						</form>
						<a href='email_vietnam.php' class="forgot-password">Quên mật khẩu?</a>
					</div>
					<div class="col-md-4 col">
						...
						<form class="main-form">
							...
							<div class="form-group">
								<input type="text" class="form-control" placeholder="Thư điện tử">
							...
							<input type="submit" value="Đăng ký" class="btn btn-default btn-ghost">
						</form>
					</div>
				</div>
			</div>
...
<audio autoplay src="vietnam.mp3">
