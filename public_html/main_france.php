...
<div id="container">
          ...
          <h1 id="e6" class="header">Mes Données</h1>

        <div class="graph_action">
			<button onClick="window.location.href= 'index_fr.php' ">de'connexion</button>
        </div>
...
countdown();
    ...
    <p>Temps de mise a` jour: <span id="cdown" style="color:blue; font-size:20px"></span></p>
                    
    </br>
    <center><p>coeur battant</p></center>
...
"window.print();"target="_ blank" style="cursor:pointer;">Imprimer des donne'es</a></center>

<a href="http://phuocdang.esy.es/GPS/place_marker.html">Carte</a>
    <div id="footer">
                <p>Controle et acquisition de donne'es par Internet</p>
                </div><!--#footer-->
  </div><!--#container-->
