...
<div id="container">
        ...
        <div class="graph_action">
			<button onClick="window.location.href= 'index_us.php' ">Log out</button>
        </div>
...
countdown();
    ...
    <center><p>Heart Beat,Sp02</p></center>
...
"window.print();"target="_ blank" style="cursor:pointer;">PRINT DATA</a></center>

<a href="http://phuocdang.esy.es/GPS/place_marker.html">Map</a>
    <div id="footer">
                <p>DEVELOPMENT OF A CLOSED SYSTEM FOR CONTROLLING, COLLECTING DATA AND SUPERVISING THROUGH INTERNET</p>
                </div><!--#footer-->
  </div><!--#container-->
...
<audio autoplay src="usa_main.mp3">
</body>
</html>