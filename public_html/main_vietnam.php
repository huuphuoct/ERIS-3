...
<div id="container">
          ...
          <h1 id="e6" class="header">Dữ liệu</h1>

        <div class="graph_action">
			<button onClick="window.location.href= 'index_vi.php' ">Đăng xuất</button>
        </div>
...
countdown();
    ...
    <p>Th&#7901;i gian c&#7853;p nh&#7853;t: <span id="cdown" style="color:blue; font-size:20px"></span></p>
                    
    </br>
    <center><p>Nhip tim</p></center>
...
"window.print();"target="_ blank" style="cursor:pointer;">In D&#7919; Li&#7879;u</a></center>

<a href="http://phuocdang.esy.es/GPS/place_marker.html">B&#7843;n &#273;&#7891;</a>

    <div id="footer">
                <p>Đo Lường Và Điều Khiển Thông Qua Mạng Internet</p>
                </div><!--#footer-->
  </div><!--#container-->
